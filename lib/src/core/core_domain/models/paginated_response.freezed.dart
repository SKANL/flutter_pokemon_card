...
mixin _$PaginatedResponse<T> {
 ...
 List<T> get data; int? get page; int? get pageSize; int get count; int get totalCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(data),page,pageSize,count,totalCount);

@override
String toString() {
  return 'PaginatedResponse<$T>(data: $data, page: $page, pageSize: $pageSize, count: $count, totalCount: $totalCount)';
}
...
@useResult
$Res call({
 List<T> data, int? page, int? pageSize, int count, int totalCount
});
...
/// Create a copy of PaginatedResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? data = null,Object? page = freezed,Object? pageSize = freezed,Object? count = null,Object? totalCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<T> data,  int? page,  int? pageSize,  int count,  int totalCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginatedResponse() when $default != null:
return $default(_that.data,_that.page,_that.pageSize,_that.count,_that.totalCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<T> data,  int? page,  int? pageSize,  int count,  int totalCount)  $default,) {final _that = this;
switch (_that) {
case _PaginatedResponse():
return $default(_that.data,_that.page,_that.pageSize,_that.count,_that.totalCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<T> data,  int? page,  int? pageSize,  int count,  int totalCount)?  $default,) {final _that = this;
switch (_that) {
case _PaginatedResponse() when $default != null:
return $default(_that.data,_that.page,_that.pageSize,_that.count,_that.totalCount);case _:
  return null;
...
class _PaginatedResponse<T> implements PaginatedResponse<T> {
  const _PaginatedResponse({required final  List<T> data, this.page, this.pageSize, required this.count, required this.totalCount}): _data = data;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_data),page,pageSize,count,totalCount);
...
/// Create a copy of PaginatedResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? data = null,Object? page = freezed,Object? pageSize = freezed,Object? count = null,Object? totalCount = null,}) {
